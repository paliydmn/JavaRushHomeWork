...
public class Solution
{
    ...
    static class Circle implements Movable//, Drawable
    {
        ...
        public void draw()
        {
            System.out.println("can be drawn - Circle");
        }

        public void move()
        {
            System.out.println("can be moved  - Circle");
        }
    ...
    static class Rectangle implements Drawable
    {
        public void draw()
        {
            System.out.println("can be drawn - Rectangle");
        }

        public void move()
        {
            System.out.println("can be moved - Rectangle");
        }
    }
}
