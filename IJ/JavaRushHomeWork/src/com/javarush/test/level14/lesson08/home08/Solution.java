...
public class Solution
{
    ...
    static abstract class OceanAnimal
    {
       ...
       /* public void walk()
        {
            System.out.println(getCurrentAnimal().getClass().getSimpleName() + " is walk");
        }*/
        abstract Swimable getCurrentAnimal();
        //abstract Walkable gerCurrentAnimal();
    }

    static class Orca extends OceanAnimal implements Swimable
    {
    ...
    static class Whale extends OceanAnimal implements Swimable
    {
