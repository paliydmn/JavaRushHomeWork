...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) {
        ...
        String subStr = null;
        int lengthofStr = string.split("\t").length;
        ...
        try{
                ...
                subStr = string.substring(firstTabindex+1,lastTabindex);
        ...
        catch (Exception e)
        {
            ...
            {
                throw new RuntimeException(e.toString(), new TooShortStringFirstThreadException());
            } else if ( threadName.equals(SECOND_THREAD_NAME))
            {
                throw new RuntimeException(e.toString(), new TooShortStringSecondThreadException());
            }else {
