...
public class Dog implements Pet {
     ...
     * Иначе вывести фразу: "имя_собаки лает гааав! сегодняшняя_дата". Пример для i=3, " *** Тузик ***  лает гаав! 13-ноя-2013 Ср"
    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable
        {
            ...
            public String say()
            {
                ...
                {
                    StringBuilder sb = new StringBuilder("а");
                    for (int k = i -1; k > 0; k--)
                        sb.append("а");

                    total = getName() + " лает г" + sb.toString() + "в! " + formatter.format(new Date());
                }
                return total;
            }
        }
