...
public class Solution {
    ...
    public static void sort(final List<Stock> list) {
            ...
            public int compare(Stock stock1, Stock stock2) {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(stock1.containsKey("charge"))
                            finalPrice = (Double) stock1.get("charge");
                        else
                            finalPrice = (Double) stock1.get("last") - (Double)stock1.get("open");

                        if(stock2.containsKey("charge"))
                            finalPrice2 = (Double) stock2.get("charge");
                        else
                            finalPrice2 = (Double) stock2.get("last") - (Double)stock2.get("open");

                        result = finalPrice2.compareTo(finalPrice);
                        if(result !=0)
                            return result;
                        else
                            return 0;
